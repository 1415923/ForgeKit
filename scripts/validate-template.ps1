...
function Test-AIEngineeringLoop {
    ...
    Test-RequiredPattern "project-template\.forgekit\docs\document-responsibility.md" "Managed Docs Responsibility Matrix v2" "Document responsibility v2 title"
    Test-RequiredPattern "project-template\.forgekit\docs\document-responsibility.md" "Document Class" "Document responsibility class column"
    Test-RequiredPattern "project-template\.forgekit\docs\document-responsibility.md" "Audience" "Document responsibility audience column"
    Test-RequiredPattern "project-template\.forgekit\docs\document-responsibility.md" "Default Read" "Document responsibility default read column"
    Test-RequiredPattern "project-template\.forgekit\docs\document-responsibility.md" "Do Not Write Here" "Document responsibility do-not-write column"
    ...
    Test-RequiredPattern "project-template\docs\codebase-map.md" "Role: code search entry, not project encyclopedia." "Codebase map search-entry boundary"
    ...
    Test-RequiredPattern "project-template\docs\work-log.md" "recent work-window log" "Work log recent window purpose"
    ...
    Test-RequiredPattern "project-template\docs\work-log.md" "not a full history warehouse" "Work log history boundary"
    Test-RequiredPattern "project-template\docs\work-log.md" "Sensitive operational data" "Work log sensitive info boundary"
