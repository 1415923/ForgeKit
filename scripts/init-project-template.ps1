...
Write-Host "1. Codex starts from AGENTS.md; Claude Code starts from CLAUDE.md"
Write-Host "2. Claude Code may also read .claude/skills/forgekit-project-workflow/SKILL.md"
