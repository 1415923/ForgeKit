...
skip_template_path() {
  local relative_path="${1//\\//}"
  case "$relative_path" in
    .forgekit/template-manifest.json|.forgekit/template-lock.json|.forgekit/upgrade-report.md|.forgekit/archive-plan.md|.forgekit/archive-apply-report.md|.forgekit/archive-reference-report.md|.forgekit/current-docs-sync-report.md|.forgekit/smart-archive-report.md|.forgekit/upgrade-export/*)
      return 0
      ;;
    *)
      return 1
