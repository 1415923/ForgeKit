  ...
  cat > "$state_file" <<EOF
{
  ...
  "features": {
    ...
    "first_principles_adversarial_review": true,
    "idempotent_safe_migrations": true,
    "active_current_docs_integrity_guard": true,
    "multi_project_scoped_docs_available": true,
    "multi_project_scoped_docs_enabled": false,
    "work_session_checkpoint": true,
    "usage_playbook": true,
    "minimal_project_capsule_bootstrap": true,
...
Use this file as initialization metadata. Merge real project facts into .forgekit/docs/project-plan.md, .forgekit/docs/project-plan.md, .forgekit/docs/codebase-map.md, .forgekit/docs/testing.md, and .forgekit/docs/tech-decisions.md manually or with Codex.
...
Use this file as Claude Code initialization metadata. Merge real project facts into .forgekit/docs/project-plan.md, .forgekit/docs/project-plan.md, .forgekit/docs/codebase-map.md, .forgekit/docs/testing.md, and .forgekit/docs/tech-decisions.md manually or with Claude Code.
...
5. .forgekit/docs/testing.md
6. .forgekit/docs/codex-next-work-order.md
7. .forgekit/docs/project-plan.md, .forgekit/docs/project-plan.md, .codex/commands.md
