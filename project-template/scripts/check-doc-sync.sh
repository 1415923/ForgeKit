...
changed_paths() {
  ...
  } | awk 'NF' | grep -v '^.forgekit/upgrade-export/' | grep -v '^.forgekit/upgrade/' | grep -v '^.forgekit/archive/' | grep -v '^.forgekit/archive-plan.md$' | grep -v '^.forgekit/archive-apply-report.md$' | grep -v '^.forgekit/archive-reference-report.md$' | grep -v '^.forgekit/current-docs-sync-report.md$' | grep -v '^.forgekit/smart-archive-report.md$' | grep -v '^.forgekit/smart-archive-apply-report.md$' | grep -v '^.forgekit/codex-native-agent-report.md$' | grep -v '^.forgekit/doc-health-report.md$' | grep -v '^.forgekit/source-trace-report.md$' | grep -v '^.forgekit/handoff-package.md$' | grep -v '^.forgekit/changes/[^/]*/handoff.md$' | sort -u
}
