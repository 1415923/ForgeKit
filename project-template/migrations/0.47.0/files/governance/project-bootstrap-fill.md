...
<!-- forgekit:section s-37eabd91436a -->
## 输出文档映射

| 问答内容 | 目标文档 |
| --- | --- |
| 项目名称、目标、用户、交付形式、阶段 | `.forgekit/docs/project-plan.md`、`.forgekit/docs/project-plan.md` |
| 当前版本范围、必须做、不做、验收标准 | `.forgekit/docs/project-plan.md`、`.forgekit/docs/version-roadmap.md`、`.forgekit/docs/task-board.md` |
...
<!-- forgekit:section s-73763fd81a6d -->
## 填充原则
...
<!-- forgekit:section s-1752274e64f5 -->
## 模式差异

| 模式 | 必填文档 |
| --- | --- |
| Lite | `.forgekit/docs/project-plan.md`、`.forgekit/docs/project-plan.md`、`.codex/commands.md`、`.forgekit/docs/project-plan.md`、`.forgekit/docs/changelog.md` |
...
<!-- forgekit:section s-fa4aa984fecc -->
## 完成标准
