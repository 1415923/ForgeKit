...
<!-- forgekit:section s-0919001a2f31 -->
## 四层结构
...
<!-- forgekit:section s-5b46bf34b09d -->
## 入口选择
...
<!-- forgekit:section s-1b6e2b2a52bc -->
## 通用闸门
...
<!-- forgekit:section s-96c471224775 -->
## 推荐阅读顺序

新项目：

1. `governance/sdlc.md`
2. `.forgekit/docs/project-plan.md`
3. `.forgekit/docs/version-roadmap.md`
...
1. `.codex/handover.md`
2. `.forgekit/docs/handover-audit.md`
3. `.forgekit/docs/defect-fix-plan.md`
4. `.forgekit/docs/version-roadmap.md`
