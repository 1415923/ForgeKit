...
Do not use for future design, new-project initialization, automatic generation of a governance suite, current work logging, or writing a plan as completed work.
